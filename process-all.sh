...
echo "$UNCOMPLETED_FILES" | while read MD_FILE; do
  ...
  # Run claude-code with the task for this file
  claude-code "Read the file claude/$MD_FILE and implement all the recommendations in the corresponding HTML file.
